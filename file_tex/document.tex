...
\begin{figure*}[htb]
	\centering
	\includegraphics[width=0.75\linewidth]{imgs/landaulevel_ketiep.pdf}
...
\begin{figure*}[htb]
	\centering
	\includegraphics[width=0.75\linewidth]{imgs/meff1.pdf}
	\caption{Khối lượng hiệu dụng $m*/m_{0}$ tại $q = 4723$.}
\end{figure*}
\begin{figure*}[htb]
	\centering
	\includegraphics[width=0.75\linewidth]{imgs/meffTNN.pdf}
	\caption{Khối lượng hiệu dụng $m*/m_{0}$ tại $q = 4723$.}
\end{figure*}

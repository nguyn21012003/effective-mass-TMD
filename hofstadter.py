...
import numpy as np
from numpy._core.multiarray import matmul
...
class Material:
    ...
    def __init__(self, name: str, model: str, approx: str) -> None:
        self.name = name  #### MoS2 or MoSe2...
        self.model = model  ### NN or TNN
        self.approx = approx

        if self.model == "NN":
            self.params = ModelNN[self.approx]
        elif self.model == "TNN":
            self.params = ModelTNN[self.approx]
...
def main():
    material = Material("MoS2", "TNN", "GGA")
